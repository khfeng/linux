...
u8 _rtw_set_chplan_cmd(_adapter *adapter, int flags, u8 chplan, const struct country_chplan *country_ent, u8 swconfig, u8 intersect)
{
	struct cmd_obj *cmdobj;
...
{
	return _rtw_set_chplan_cmd(adapter, flags, chplan, NULL, swconfig, _FALSE);
}
...
inline u8 rtw_set_country_cmd(_adapter *adapter, int flags, const char *country_code, u8 swconfig)
{
	...
	return _rtw_set_chplan_cmd(adapter, flags, RTW_CHPLAN_UNSPECIFIED, ent, swconfig, _FALSE);
}

u8 rtw_set_country_entry_cmd(_adapter *adapter, int flags,
			     const struct country_chplan *ent,
			     u8 intersect)
{
	return _rtw_set_chplan_cmd(adapter, flags, RTW_CHPLAN_UNSPECIFIED, ent, _FALSE, intersect);
}
