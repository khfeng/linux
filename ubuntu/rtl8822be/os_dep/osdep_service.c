...
inline u32 rtw_systime_to_sec(u32 systime)
{
#ifdef PLATFORM_LINUX
	return systime / HZ;
#endif
...
inline u32 rtw_sec_to_systime(u32 sec)
{
#ifdef PLATFORM_LINUX
	return sec * HZ;
#endif
...
/* the input parameter start use the same unit as returned by rtw_get_current_time */
inline s32 rtw_get_passing_time_sec(u32 start)
{
#ifdef PLATFORM_LINUX
	return rtw_systime_to_sec(jiffies - start);
#endif
#ifdef PLATFORM_FREEBSD
	return rtw_systime_to_sec(rtw_get_current_time());
#endif
#ifdef PLATFORM_WINDOWS
	LARGE_INTEGER	SystemTime;

	NdisGetCurrentSystemTime(&SystemTime);
	return rtw_systime_to_sec((u32)(SystemTime.LowPart) - start);
#endif
}
