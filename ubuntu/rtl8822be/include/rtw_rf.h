...
enum rtw_sku_detf {
	RTW_DETF_SMBIOS_COUNTRY = BIT(0),
	RTW_DETF_EFUSE_COUNTRY = BIT(1),
	RTW_DETF_CH_PLAN = BIT(2),
	RTW_DETF_SPECIAL_COUNTRY = BIT(3),
};
...
#define RTW_SKU_LEASE_AGE (2 * 60 * 60) /* 2hr (unit: sec) */

struct rtw_sku {
	u32 detflags; /* enum rtw_sku_detf */
	enum rtw_sku_state state;
	u32 age;
};
...
#else
#define rtw_sku_set_det_flag(a, f)
#define rtw_sku_check_if_deting(a) false
#define rtw_sku_start_det_if_need(a) false
#define rtw_sku_check_if_exp_scan(a) false
#define rtw_sku_check_and_apply_regd(a, a2) false
#define rtw_sku_confirm_detection(a)
